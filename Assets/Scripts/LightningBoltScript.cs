...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            AddColliderToLine(lineRenderer, StartObject.transform.position, EndObject.transform.position);
        }
        ...
        private void AddColliderToLine(LineRenderer line, Vector3 startPoint, Vector3 endPoint)
        {
            ...
            BoxCollider lineCollider = transform.gameObject.AddComponent<BoxCollider>();
